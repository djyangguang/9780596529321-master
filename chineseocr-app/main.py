...
class TextOcrModel(object):
    ...
    def ocr_batch(self,img,boxes,leftAdjustAlph=0.0,rightAdjustAlph=0.0):
        ...
        for index,box in enumerate(boxes):
            partImg,box = rotate_cut_img(im,box,leftAdjustAlph,rightAdjustAlph) # 旋转裁切图片。
            box['img'] = partImg.convert('L')#  L = R * 299/1000 + G * 587/1000+ B * 114/1000  转换。看下面这个，我明明转换成L了，为什么输出的图像还有颜色呢？不是应该是灰度图吗？
